...
Die Kursfallstudie verlangt eine relationale Olympia-Datenbank und eine Auswertung des Medaillenerfolgs. Die Kursvorlage modelliert vier Tabellen (`Athletes`, `Events`, `Countries`, `Athlete_Event`). Ich habe ein Sternschema gebaut, weil Alter, Größe und Gewicht zum Olympiajahr gehören, nicht zur Person.
...
2. CSV importieren in pgAdmin (Import/Export bzw. `COPY`).
...
- Im Kursdatensatz nur Sommerspiele 1904–2016 (26 Jahre in dim_date). 1896, 1900 und eigene Winterspiele-Jahre kommen in den Rohdaten nicht vor.
